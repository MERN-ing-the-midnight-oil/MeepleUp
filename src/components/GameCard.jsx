...
const styles = StyleSheet.create({
  ...
  thumbnailContainer: {
    width: '100%',
    height: 80, // Taller for game box side appearance
  ...
  cardContent: {
    padding: 16,
    minHeight: 100, // Minimum height for game box side appearance
  },
  cardContentExpanded: {
    minHeight: 'auto',
  },
  ...
  styledCardContainer: {
    width: '100%',
    minHeight: 100, // Taller for game box side appearance
    borderRadius: 12,
    overflow: 'hidden',
  },
  ...
  styledCardContent: {
    padding: 16,
    minHeight: 120, // Minimum height for game box side appearance
    justifyContent: 'space-between',
  },
